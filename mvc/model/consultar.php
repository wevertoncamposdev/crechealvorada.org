...
$sql = "SELECT DISTINCT `data` FROM crech964_site.transparencia WHERE tipo = '$query' ORDER BY `data` DESC; ";
...
?>
        ...
        <div class="accordion" id="accordion<?php echo $year; ?>">
            <div class="accordion-item">
                ...
                $sql2 = "SELECT DISTINCT `secao` FROM crech964_site.transparencia WHERE tipo = '$query' AND `data` = '$data'; ";
                /* SELECT DISTINCT `secao` FROM crech964_site.transparencia WHERE tipo = 'cmdca' AND `data` = '2018-01-01'; */
                ...
                ?>
                        ...
                        <div id="collapse<?php echo $year; ?>" class="accordion-collapse collapse" aria-labelledby="heading<?php echo $year; ?>" data-bs-parent="#accordion<?php echo $year; ?>">
                            ...
                            <div class="accordion-body">
                                ...
                                ?>
                                        <!-- Enviando dados do arquivo para a view -->
